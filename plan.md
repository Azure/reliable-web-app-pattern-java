...
With these changes complete, the simplified Proseware multi-region solution is adjusted as shown. Traffic Manager no longer sends data to the *westus3* region.
...
<!-- todo -->
### WIP: Validate the *eastus* traffic
Todo describe the recommendation for the *eastus* region to be tested before we send traffic

### WIP: Send traffic to *eastus*
